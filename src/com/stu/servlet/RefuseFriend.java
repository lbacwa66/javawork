...
/**
 * Servlet implementation class RefuseFriend
 */
public class RefuseFriend extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 请求方 放在前面
		FriendReqCtrl.refuseFriendReq(friend.getUser_id(), account.getUser_id());
